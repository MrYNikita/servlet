...
public final class Methods {
    ...
    public static String[] getFilePoints0(String path) {
        ...
        for (File file : fileCatalog) {
            ...
            if (file.isFile()) {
                strb.append(
                    String.format(
                        "<p><a download href=\"http://localhost:8080/computer_directory/downloads?path=%s\">%s</a>%s" + file.length()/(1024 * 1024) + "mb%s%s" + " </p>",
